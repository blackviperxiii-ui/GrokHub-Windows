...
**v2.8.0** — Grok Build **1.0.17**. History is `grok sessions` 1:1. MCP tools can ask for a form or URL. `/usage` includes persisted session spend. Per-user installer.

## Install

1. Download **GrokHub-Setup-2.8.0.exe** from [Releases](https://github.com/blackviperxiii-ui/GrokHub-Windows/releases/latest).
