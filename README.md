...
**v2.8.1** — Grok Build **1.0.17**. History is `grok sessions` 1:1. `/update` overlays the GUI and updates `grok`. MCP tools can ask for a form or URL. Per-user installer.

## Install

1. Download **GrokHub-Setup-2.8.1.exe** from [Releases](https://github.com/blackviperxiii-ui/GrokHub-Windows/releases/latest).
